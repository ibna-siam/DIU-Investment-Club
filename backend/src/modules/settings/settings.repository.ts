...
const inMemoryDefaults: Record<string, any> = {
  ...
  contact_email: '252-58-083@diu.edu.bd',
  reply_to_email: '252-58-083@diu.edu.bd',
  ...
  footer_text: 'Questions or inquiries? Reply directly to this email or contact 252-58-083@diu.edu.bd.',
  club_logo_url: '',
